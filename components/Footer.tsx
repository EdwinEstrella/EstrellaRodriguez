...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand-orange transition-colors duration-300">
        {children}
    </a>
);
        ...
        <footer className="bg-gray-800 text-white">
            <div className="container mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center mb-4">
                            <BookOpenIcon className="h-8 w-8 text-brand-yellow" />
                            <span className="ml-3 text-xl font-bold">Estrella Rodriguez</span>
                        </div>
                        <p className="text-gray-400 max-w-md">
                            Brindando apoyo académico de calidad para forjar el futuro de nuestros estudiantes.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li>(123) 456-7890</li>
                            <li>contacto@salarodriguez.com</li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
                    <p>&copy; {new Date().getFullYear()} Estrella Rodriguez. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
